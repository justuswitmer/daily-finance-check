...
- Set secrets: `fly secrets set PLAID_CLIENT_ID=... PLAID_SECRET=... TWILIO_ACCOUNT_SID=... TWILIO_API_KEY_SID=... TWILIO_API_KEY_SECRET=... TWILIO_MESSAGING_SERVICE_SID=... CONVERSATION_SID=...`
- `fly deploy`
